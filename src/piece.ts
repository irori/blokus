class Piece {
  ...
  constructor(public id: number, coords: [number, number][]) {
...
class Rotation {
  ...
  constructor(config: [number, number, Piece]) {
...
class Block {
  ...
  constructor(private id: number, public size: number, rotations: [number, number, Piece][]) {
    this.rotations = [];
    for (let i = 0; i < 8; i++)
...
export const pieceSet: {[index: string]: Piece} = {
