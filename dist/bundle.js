...
var Move = function () {
  function Move(x, y, piece_id) {
    ...
    if (arguments.length == 3) this.m = x << 4 | y | piece_id << 8;else if (typeof x == 'number') this.m = x;else if (x == '----') this.m = 0xffff;else {
    ...
    value: function updateBoard(moveToHighlight) {
      ...
      for (var y = 0; y < 14; y++) {
        for (var x = 0; x < 14; x++) {
          ...
          var cls = { violet: 'block0', orange: 'block1' }[col];
...
var Input = function () {
  ...
  createClass(Input, [{
    ...
    value: function drag(e) {
      ...
      var elem = e.currentTarget;
      var deltaX = e.clientX - elem.offsetLeft;
      var deltaY = e.clientY - elem.offsetTop;
      var touchClick = true;
      ...
      var upHandler = function upHandler(e) {
        ...
        var bpos = _this2.toBoardPosition(e.clientX - deltaX, e.clientY - deltaY);
        if (bpos) {
